...
public class MoimVO {
	...
	public String toString() {
		return "MoimVO [moimSq=" + moimSq + ", moimCd=" + moimCd + ", moimTitle=" + moimTitle + ", moimTag=" + moimTag
				+ ", moimCa=" + moimCa + ", moimMemId=" + moimMemId + ", moimIntro=" + moimIntro + ", moimDelFl="
				+ moimDelFl + ", moimIsOkFl=" + moimIsOkFl + ", moimHit=" + moimHit + ", moimDate=" + moimDate
				+ ", moimHour=" + moimHour + ", moimMin=" + moimMin + ", moimAgeOption=" + moimAgeOption
				+ ", moimGender=" + moimGender + ", moimSdate=" + moimSdate + ", moimEdate=" + moimEdate
				+ ", moimZipCode=" + moimZipCode + ", moimAddress=" + moimAddress + ", moimAddressSub=" + moimAddressSub
				+ ", moimZoneCode=" + moimZoneCode + ", moimAddressAdd=" + moimAddressAdd + ", moimCnt=" + moimCnt
				+ ", rNum=" + rNum + "]";
	}
