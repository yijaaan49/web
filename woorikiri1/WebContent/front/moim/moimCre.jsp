...
<script type="text/javascript" src="/22_Moim_Board/smartEditor2/js/service/HuskyEZCreator.js"></script>
	...
	<table border>
		<tr>
			...
			<td>
				...
				<select name="ca002">
					<option value="">::선택</option>
					<option value="001">모임</option>
	  				<option value="002">축구</option>
	  				<option value="003">배틀그라운드</option>
				</select>
				<select name="ca003">
					<option value="">::선택</option>
					<option value="001">축구모임</option>
	  				<option value="002">게임모임</option>
	  				<option value="003">회화모임</option>
				</select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>모집인원</th>
			<td>
				<input type="text" name="moimCnt">명
			</td>
		</tr>
		<tr>
			<th>모임장소</th>
		...
		<tr>
			<th>모임접수기간</th>
			<td>
			<input type="text" name="moimSdate" id="fromDate">시작일&nbsp;~&nbsp;
			<input type="text" name="moimEdate" id="toDate">종료일
			</td>
		</tr>
		<tr>
			<th>참가연령</th>
		...
		<tr>
			<th>상세소개</th>
			<td><textarea rows="40" cols="60" id="popContent" name="intro"></textarea></td>
		</tr>
		<tr>
			<th>태그</th>
			<td colspan="3">
...
nhn.husky.EZCreator.createInIFrame({
    ...
    sSkinURI: "/22_Moim_Board/smartEditor2/SmartEditor2Skin.html",  //skin경로
    fCreator: "createSEditor2",
});
</script>
<script>
	function create_moim(frm){
		frm.action="<%=request.getContextPath()%>/Frontcontroller?type=moimCre";
		frm.submit();
		alert("모임이 생성되었습니다");
	}
	function back_main(){
		location.href="moimIndex.jsp";
	}
