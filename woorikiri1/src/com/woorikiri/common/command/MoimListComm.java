...
public class MoimListComm implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageVO p = new PageVO();
		// 1. 전체 게시물의 수를 구한다.
		p.setTotalRecord(MoimDAO.getTotalCount(cate));
		...
		map.put("cate2", request.getParameter("cate"));
		
		List<MoimVO> list = MoimDAO.getList(map);
