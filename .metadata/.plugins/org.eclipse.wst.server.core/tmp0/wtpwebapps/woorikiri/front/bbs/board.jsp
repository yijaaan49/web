...
<div class="bbs_basic">
	...
	전체삭제 <input type="checkbox" name="sno" value="${k.sno }">
	<table cellpadding="0" cellspacing="0">
		<c:forEach var="k" items="${list}">
			<tr>
				<td class="date">
				<input type="checkbox" name="sno" value="${k.sno }">
					<c:choose>
...
<div class="paging">
	...
	<div class="btn_top">
		<a><img src="<%=FRONT_IMG_URL%>/common/btn_toㄴp.gif" alt="페이지 상단으로" /></a>
	</div>
	
	<input type="button" value="글쓰기" onclick="location.href='<%=request.getContextPath()%>/Frontcontroller?type=board&work=write&way=write&bdId=${bdId}&cPage=${pvo.nowPage}'"/>
